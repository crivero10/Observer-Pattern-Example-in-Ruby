...
#Ensures that the class Twitter works as expected.
class TwitterTest < Minitest::Test

  #Setup of instance variables to be used in the tests.
  def setup
    @out = StringIO.new
    @old_stdout = $stdout
    $stdout = @out
  ...
  #Changes the value of reference to stdout
  def teardown
    $stdout = @old_stdout
  end

  #Tests that the tweet and follow functions  work as expected.
